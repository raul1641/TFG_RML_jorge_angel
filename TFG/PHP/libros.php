...
$consulta_total = "SELECT COUNT(*) as total FROM rmolinal_PROYECTO_JORGE_ANGEL "; // Consulta SQL para contar todos los libros
...
$consulta = "SELECT id_libro, titulo, autor, estado FROM rmolinal_PROYECTO_JORGE_ANGEL  LIMIT ?, ?"; // Consulta preparada
