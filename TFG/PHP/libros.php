...
$consulta_total = "SELECT COUNT(*) as total FROM registro_libros.libro"; // Consulta SQL para contar todos los libros
...
$consulta = "SELECT id_libro, titulo, autor, estado FROM registro_libros.libro LIMIT ?, ?"; // Consulta preparada
